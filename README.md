...
·	GitHub Pages (free, recommended): create a repo, upload all files in this folder to it, enable Pages in repo Settings → Pages → "Deploy from branch", then open the given https://ash-171.github.io/streakly/ URL on your phone.
