...
·	GitHub Pages (free, recommended): create a repo, upload all files in this folder to it, enable Pages in repo Settings → Pages → "Deploy from branch", then open the given https://yourname.github.io/repo/ URL on your phone.
